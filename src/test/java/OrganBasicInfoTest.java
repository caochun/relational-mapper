...
//RENAME : 'ρ';
    ...
    public void test(){
        ...
        String line = "" +
                "ρ T3.B01BH PAYMENT_CODE, T1.ORGN_NUM ORGANKEY, T3.B010R BANKLICENCE, T3.B01BG CREDIT_CODE, T1.ORGN_NAM ORGANNAME, " +
        ...
        System.out.println(sqlGenerator.format(line));
    }
}
